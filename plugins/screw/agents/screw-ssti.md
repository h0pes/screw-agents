...
1. `agent_part` = `"ssti"` (this subagent's name: sqli/cmdi/ssti/xss)
...
Rationale: The YAML agent for ssti (injection-input-handling) could not statically
