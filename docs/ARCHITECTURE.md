...
| Phase 5 | **One-time** | Multi-LLM Challenger | In progress — config/model contracts, reconciliation, provider runner interface, fixture-backed required-mode orchestration, and Claude/Codex subscription-backed CLI runner plumbing are implemented; see `docs/PHASE_5_PLAN.md` |
