...
| Phase 5 | **One-time** | Multi-LLM Challenger | In progress — config/model contracts, reconciliation, and provider runner interface are implemented; see `docs/PHASE_5_PLAN.md` |
