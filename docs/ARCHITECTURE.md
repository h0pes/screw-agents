...
| Phase 5 | **One-time** | Multi-LLM Challenger | In progress — config/model contracts, reconciliation, provider runner interface, fixture-backed required-mode orchestration, Claude/Codex subscription-backed CLI runner plumbing, and runner factory wiring are implemented; see `docs/PHASE_5_PLAN.md` |
