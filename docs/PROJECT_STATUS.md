...
- Phase 5 challenger package has provider-neutral config/model contracts in
  ...
  can optionally finalize returned findings into normal reports. Live CLI and
  composed-mode validation remain pending before provider-neutral primary
