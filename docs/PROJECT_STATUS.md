...
- Phase 5 challenger package has provider-neutral config/model contracts in
  ...
  recorded in `docs/PHASE_5_MANUAL_VALIDATION.md`; provider-scan, composed,
  and parallel workflows can finalize returned findings into normal reports
  with mode-aware filename prefixes and JSON/Markdown/SARIF metadata. One live
